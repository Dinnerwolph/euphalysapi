...
public class GTempBanCommands extends AbstractCommands {

    public GTempBanCommands() {
        super("gtempban", "euphalys.cmd.gtemban");
    }
    ...
    protected void displayHelp() {
        player.sendMessage("/gtemban <player> <duration> <message>");
    }
}
