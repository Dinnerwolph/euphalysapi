    ...
    public void loadAllGroup() {
        try {
            ...
            while (resultSet.next()) {
                api.addGroup(new Group(resultSet.getInt("id"), resultSet.getString("name"), resultSet.getString("displayName"), resultSet.getInt("ladder"), getPermissions(resultSet.getInt("id"))));
            }
            connection.close();
        } catch (SQLException e) {
            e.printStackTrace();
