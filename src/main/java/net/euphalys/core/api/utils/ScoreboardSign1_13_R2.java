...
public class ScoreboardSign1_13_R2 implements IScoreboardSign {
     ...
     */
    public ScoreboardSign1_13_R2(Player player, String objectiveName) {
        this.player = player;
    ...
    /**
     * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link ScoreboardSign1_13_R2#create()} in order
     * to be used again
     */
    public void destroy() {
        if (!created)
    ...
    public void setLine(int line, String value) {
        ...
        if (old != null && created && team.playerChanged)
            getPlayer().sendPacket(removeLine(old, line));
    ...
    public class VirtualTeam {
        ...
        private PacketPlayOutScoreboardTeam createPacket(int mode) {
            ...
            setField(packet, "g", EnumChatFormat.a(0));
