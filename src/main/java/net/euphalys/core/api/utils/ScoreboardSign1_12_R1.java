...
public class ScoreboardSign1_12_R1 implements IScoreboardSign {
     ...
     */
    public ScoreboardSign1_12_R1(Player player, String objectiveName) {
        this.player = player;
    ...
    /**
     * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link ScoreboardSign1_12_R1#create()} in order
     * to be used again
     */
    public void destroy() {
        if (!created)
