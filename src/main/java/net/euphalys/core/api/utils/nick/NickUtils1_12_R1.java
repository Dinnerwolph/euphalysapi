 ...
 * @author Dinnerwolph
 */
public class NickUtils1_12_R1 implements INickUtils {
    ...
    private void updateSkin(EntityPlayer player, String name) throws IOException {
        ...
        if (player.getChatFlags() == EntityHuman.EnumChatVisibility.HIDDEN) {
        ...
        try {
            Field field = player.getClass().getSuperclass().getDeclaredField("g");
