 ...
 * @author zyuiop
 */
public class ScoreboardSign1_8_R3 implements IScoreboardSign {
    ...
    /**
     * Send the packets to remove this scoreboard sign. A destroyed scoreboard sign must be recreated using {@link ScoreboardSign1_8_R3#create()} in order
     * to be used again
     */
    public void destroy() {
        if (!created)
